...
public class driver {
  public static void main(String[]args) throws AutoException{
	  System.out.println(" ******** Print autoinfo *********\n");
	  BuildAuto ba=new BuildAuto();
	  ba.BuildAuto("Focus_Wagon_ZTW.txt");
	  ba.PrintAuto("Focus Wagon ZTW");
	  
	  System.out.println("====================");
	 /**************test OptionSet*******************/
	  System.out.println("********  Test OptionSet *********\n" );
	  ba.updateOptionSetName("Focus Wagon ZTW", "Color","ColorSet");
	  ba.PrintAuto("Focus Wagon ZTW");
	  System.out.println("====================");
	  /***************test Option*******************/
	  System.out.println("********  Test Option *********\n" );
	  ba.updateOptionPrice("Focus Wagon ZTW", "Transmission","Automatic", 200);
	  ba.PrintAuto("Focus Wagon ZTW");
      /******************test choice***************************/
