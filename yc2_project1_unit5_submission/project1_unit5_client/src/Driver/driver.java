  ...
  public static void main(String[]args) throws AutoException{
	 ...
	 /**************test OptionSet*******************/
	  ...
	  System.out.println("********  Test Choice *********\n" );
		Automobile auto = new FileIO().buildAutoOjectByTxt("Focus_Wagon_ZTW.txt");
		auto.setOptionChoice("Color", "Fort Knox Gold Clearcoat Metallic");
		auto.setOptionChoice("Transmission", "Automatic");
		auto.setOptionChoice("BrakesTractionControl", "ABS");
		auto.setOptionChoice("SideImpactAirbags", "Selected");
		auto.setOptionChoice("PowerMoonroof", "Selected");
